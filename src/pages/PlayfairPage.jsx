                ...
                <Container>
                    <Row className="header-box d-flex align-items-center">
                        <Col className="col-spacing">
                            ...
                            <p>Metode menyandikan teks (26 karakter alfabet) dengan mengenkripsi pasangan huruf (bigram) untuk mempersulit analisis frekuensi kemunculan huruf pada teks.</p>
                        </Col>
                        <Col className="col-spacing">
